/*
Loja de Ferramentas
Este exemplo pede o nome do usuário e três valores inteiros, os quais representam as quantidades de porcas, parafusos e arruelas compradas. Após, exibe o nome do
usuário seguido da quantidade de cada item comprado e o valor toral a ser pago.
*/
programa 
{
  funcao inicio() 
  {
      ...
      */
      ...
      total_pagar = total_parafusos + total_arruelas + total_arruelas
